...
<body>
	...
	<div class="container t-board-detail">
		...
		<div class="row">
			<div class="col-12">
				...
				<form>
					...
					<c:url value="/T_board/T_modify" var="modifyUrl">
				...
				<div class="modal-body">
					<form>
						<input type="text" value="" readonly hidden
							id="reply-rno-input2"> <input type="text"
							value="${board.bno }" readonly hidden id="reply-bno-input2">
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">작성자</label> <input
